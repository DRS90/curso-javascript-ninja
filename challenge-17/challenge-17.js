(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Douglas Rodrigo dos Santos'))
  ...
  */
  ...
  function getMonthNumber(month) {
    ...
    // const monthIndex = monthList.indexOf(month.toLowerCase())
    // const hasZero = monthIndex < 9 ? '0' : ''

    // return hasZero + (monthIndex + 1)
    const monthList = {
      'janeiro': '01',
      'fevereiro': '02',
      'março': '03',
    ...
    return (monthList[month.toLowerCase()])
  }
  ...
  */
  ...
  const regexDate = /(\d\d) de (janeiro|fevereiro|março|abril|maio|junho|julho|agosto|setembro|outubro|novembro|dezembro) de (\d\d\d\d)/gi
  ...
  */
  ...
  const replaceDate = (regex, day, month, year) => day + '/' + getMonthNumber(month) + '/' + year
