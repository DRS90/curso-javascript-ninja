(function () {
  ...
  */
  ...
  var CPF = (cpf) => {
    const cpfNumber = cleanCPF(cpf)
    return cpfNumber.replace(/(\d{3})(\d{3})(\d{3})/g, '$1.$2.$3-')
  }

  console.log(CPF("049-214 3421-1"))
  console.log(CPF("210.458.522-05"))
  console.log(CPF("735 500 794 - 22"))
  console.log(CPF("101.123-131x32"))
  ...
  */
  ...
  console.log(text.match(/julho|junho/g))
  ...
  */
  ...
  const regexTagOpen = /<\w+>/g

  let tag = "<div><section><blockquote>Texto <img /></blockquote></section></div>"

  console.log(tag.match(regexTagOpen))
  ...
  */
  ...
  const regexTagEmpty = /<\w+><\/\w+>/g
  tag = "<div><ul><li></li><li></li><li><span></span></li></ul></div>"

  console.log(tag.match(regexTagEmpty))
  ...
  */
  ...
  console.log(html.replace(/<(\w+)>([^>/]+)<\/\w+>/g, ( full, tag, text ) => {
    return ('<' + tag + '>O texto dentro da tag "' + tag + '" é ' + text + '<' + tag + '>\n')
  })
  )
})() 
//FALTA COMMITAR 
//PAREI NO VIDEO 111 AULA 19
