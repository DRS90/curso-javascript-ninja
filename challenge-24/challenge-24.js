(function (window, document) {
 ...
 function initialize() {
  ...
  function getOperations(){
    return Array.prototype.map.call($buttonsOperations, button => button.value)
  }
  ...
  function calculateAllValues(accumulated, actual) {
    ...
    return calculate(firstValue, lastValue, operator) + lastOperator
  };

  function getLastOperator(value) {
    return isLastItemAnOperation(value) ? value.split('').pop() : '';
  }
  initialize() // como tudo foi criado em função é preciso inicializar de algum modo
})(window, document)